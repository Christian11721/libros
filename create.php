                ...
                <div class="card">
                    ...
                    <form class="p-4" method="POST" action="insert.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="a_publicacion" autofocus required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Lugar de edición: </label>
                            <input type="text" class="form-control" name="lugar_edicion" autofocus required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Editorial: </label>
                            <input type="text" class="form-control" name="editorial" autofocus required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Páginas: </label>
                            <input type="text" class="form-control" name="paginas" autofocus required>
                        </div>
                        <div class="d-grid">
